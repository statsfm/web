  ...
  <section class="mt-10">
    <Container>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Sjoerd
        Software Development.
      </p>
      <br>
      <p>
        Sjoerd Software Development is committed to ensuring that the app is as
      ...
      <br>
      <p>
        The Backtrack.fm (formerly Spotistats for Spotify) app stores and
        ...
        Backtrack.fm (formerly Spotistats for Spotify) app won’t work properly
        or at all.
      </p>
      <div>
        <p>
      ...
      <br>
      <p>
        You should be aware that there are certain things that Sjoerd Software
        Development will not take responsibility for. Certain functions of the
        ...
        Sjoerd Software Development cannot take responsibility for the app not
      ...
      <br>
      <p>
        Along the same lines, Sjoerd Software Development cannot always take
        ...
        turn it on to avail the Service, Sjoerd Software Development cannot
        accept responsibility.
      </p>
      <br>
      <p>
        With respect to Sjoerd Software Development’s responsibility for your
        use of the app, when you’re using the app, it’s important to bear in
        mind that although we endeavor to ensure that it is updated and correct
        at all times, we do rely on third parties to provide information to us
        so that we can make it available to you. Sjoerd Software Development
        accepts no liability for any loss, direct or indirect, you experience as
      ...
      <p>
        ...
        updates if you want to keep using the app. Sjoerd Software Development
      ...
      <br>
      <p><h1 class="text-xl font-bold">Changes to This Terms and Conditions</h1></p>
      <p>
      ...
      <p>These terms and conditions are effective as of 2021-12-28</p>
      <br>
      <p><h1 class="text-xl font-bold">Contact Us</h1></p>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at contact@backtrack.fm.
      </p>
      <br>
